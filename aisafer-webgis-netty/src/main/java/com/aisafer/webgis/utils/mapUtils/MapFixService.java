...
*//**
	...
	public static PointLatLng wgsToGcj(double wgLat, double wgLon) {
		double mgLat = 0;
		double mgLon = 0;
	...
	public static void main(String[] args) {
		/*PointLatLng fix = MapFixService.fix(22.5565504, 131.236554, Constants.MAP_BAIDU);
		System.out.println(fix.getLat());
		System.out.println(fix.getLng());*/
	}
