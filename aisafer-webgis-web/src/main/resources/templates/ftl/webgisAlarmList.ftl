                        ...
                        <form class="layui-form" id="dataForm" onsubmit="return pagedataHandel.sumbit();" >
                            ...
                            <div class="layui-row">
                                <div class="layui-col-md4 layui-col-xs4">
                                    ...
                                    <div class="layui-col-md6 layui-col-xs6">
                                        <div class="layui-form-item">
                                            <label class="layui-form-label"><@base.spring.message  "vehicle.depName" /></label>
                                            <div class="layui-input-inline">
                                                <div class="layui-form-select" onclick="mylayer.openSpinner(this,'${base.basePath}/authc/findOrgTree?orgType=26')" id="org-select">
                                                    <div class="layui-select-title">
                                                        <input type="text" id="orgName" name="orgName" placeholder="<@base.spring.message  "msg.choose" />"value="" readonly="" class="layui-input">
                                                        <input type="hidden"  name="orgId" id="orgId"  autocomplete="off" class="layui-input"/>
                                ...
                                <div class="layui-col-md4 layui-col-xs4">
                                    <div class="layui-col-md6 layui-col-xs6">
                                    <div class="layui-form-item">
                                        <label class="layui-form-label"><@base.spring.message  "alarm.alarmType" /></label>
                                        <div class="layui-input-inline">
                                            <select name="alarmTypeId" id="alarmType" lay-filter="alarmType" lay-verify="" lay-search>
                                                <option value=""><@base.spring.message  "msg.choose" /></option>
                                            </select>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="layui-col-md6 layui-col-xs6">
                                        <div class="layui-form-item">
                                            <label class="layui-form-label"><@base.spring.message  "alarm.time" /></label>
                                            <div class="layui-input-inline">
                                                <select name="alarmTime" id="alarmTime" lay-filter="alarmTime" lay-verify="" lay-search>
                                                    <option value=""><@base.spring.message  "msg.choose" /></option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="layui-col-md4 layui-col-xs4">
                                    <button  class="layui-btn layui-btn-normal"  lay-filter="submit" style="margin: 0 15px;"><@base.spring.message  "button.search" /></button>
                                    <input type="checkbox" name="" lay-skin="primary" title="自动刷新表格" >
                                    <input type="checkbox" name="" lay-skin="primary" title="静音">
                                    <input type="checkbox" name="" lay-skin="primary" title="禁止弹框" >
                                    </div>
...
<script>
    ...
    var searchUrl = "${base.basePath}/authc/getWebgisAlarmList";
    var cols=[[ //标题栏
    ...
    $(function(){
        ...
        //加载下拉框
        createSelectId3("#alarmType", "${base.basePath}/authc/findAlarmTypes", "alarmName");
